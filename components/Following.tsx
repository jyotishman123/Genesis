  ...
  useEffect(() => {
    async function getMyFollowings() {
      try {
        ...
        const jsonData: FollowingUser[] = await followers.json();
  ...
  return (
    <div className="py-3 px-3">
      ...
      <div className="grid xl:grid-cols-2 max-h-[500px] overflow-y-scroll gap-4 my-6">
        {following.map((element: FollowingUser, index: number) => {
          return (
        ...
        <Link href={'https://github.com/jyotishman123?tab=following'}>
